...
import { texts } from './OnePageEmailForm.texts';

import styles from './OnePageEmailForm.module.scss';

export const OnePageEmailForm = () => {
    ...
    <div>
      <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
        ...
        <div className={styles.smallText}>
          ...
          <Link href={Paths.TERMS} className={styles.link}>
